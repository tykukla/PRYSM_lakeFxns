...
"""
    ...
    commands to use the lake PSM. The user can load their own data in the fields below,
...
env_input='/Users/tylerkukla/Documents/GitHub/PRYSM_examples/examples/test_data_lake/lake_model_input/ERA_INTERIM_climatology_Tanganyika.txt'
...
# xxxxxx -- f2py -c -m lakepsm env_sub.f90
# xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
# 
# (Tyler's note) Instead, run the following two lines in 
# terminal (e.g., as a proc or subproc)
# 
# (compile the code and create the lakepsm model)
# gfortran -o lakepsm_test env_sub.f90
# (run the lakepsm model)
# ./lakepsm_test
# 
# 
